        ...
        <div className="log-pose-card" style={{ marginBottom: 24 }}>
          ...
          <p className="muted" style={{ margin: 0, fontSize: 14 }}>
            {teamData?.status === "completed"
              ...
              : `Follow the Log Pose to Island ${currentLevel}. Find the Poneglyph and decode its message.`}
          </p>
        </div>
                ...
                <div key={level}>
                  ...
                  >
                    ...
                    <div className="island-info">
                      ...
                      <p>
                        {isCompleted && solved
                          ? `Decoded! +${solved.pointsEarned} bounty`
                          : isCurrent
                          ? "Currently here — find the Poneglyph!"
                          : isLocked
