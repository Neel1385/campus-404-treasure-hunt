    ...
    <div className="container narrow">
      ...
      <div className="hero" style={{ padding: "24px 0" }}>
        ...
        <p className="tagline" style={{ margin: "8px 0 0" }}>
          Set sail with your pirate crew
        </p>
      </div>
      ...
      <form className="card" onSubmit={submit}>
        <div className="field">
          <label>Crew Name or ID</label>
          <input
            value={identifier}
            onChange={(e) => setIdentifier(e.target.value)}
            required
            autoFocus
            placeholder="e.g. STRAW-HATS or crew name"
          />
        </div>
        <div className="field">
        ...
        <button className="btn block" type="submit" disabled={busy}>
          {busy ? "🧭 Reading the Log Pose..." : "⛵ Set Sail"}
        </button>
      </form>

      <p className="muted" style={{ textAlign: "center" }}>
        No crew yet? <Link to="/register">🏴‍☠️ Create your pirate crew</Link>
      </p>
    </div>
  );
}
